...
export function HeroDealsCard() {
  return (
    <Link
      href="#"
      className="block overflow-hidden rounded-[26px] border border-[#382c18] bg-[#121926]"
    >
      <div className="relative min-h-[280px] p-6 lg:min-h-[300px] lg:p-7">
        ...
        <div className="relative z-10 flex h-full max-w-[470px] flex-col justify-center">
          ...
          <h2 className="mt-3 text-4xl font-semibold uppercase leading-none text-white lg:text-[52px]">
            Focus on what matters: <span className="text-[#d4b168]">deals</span>
          </h2>
